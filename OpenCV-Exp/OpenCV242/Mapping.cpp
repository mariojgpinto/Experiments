...
int main_mapping(int argc, char* argv[]){
	cv::Mat3b _original_map = cv::imread("original_map2.png");
	//cv::Mat1b _top_view_1b = cv::imread("object_map.png");
	cv::Mat3b _top_view_3b = cv::imread("object_map.png");
	cv::Mat _top_view_1b;
	...
	get_user_points(_top_view_3b,_input_top_view,_original_map,_input_original,6);

...
const string defaultQueryImageName = "./matching_to_many_images/query.png";
const string defaultFileWithTrainImages = "./matching_to_many_images/train/trainImages.txt";
const string defaultDirToSaveResImages = "./matching_to_many_images/results";

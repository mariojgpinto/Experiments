...
void Viewer::setup_windows(){
    ...
    this->_ntk_widget_left = new ntk::ImageWidget(this->ui->main_widget_left);
	...
	this->_ntk_widget_right = new ntk::ImageWidget(this->ui->main_widget_right);
...
// Slots
//-----------------------------------------------------------------------------
void Viewer::update_window(ntk::RGBDImage* image){
...
{
	this->_ntk_widget_left->setImage(*this->_controller->get_color_image());
